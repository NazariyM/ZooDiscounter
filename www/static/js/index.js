...
var _selectInit = __webpack_require__(6);
...
var _ionRangeslider = __webpack_require__(15);
...
/** price filter range */
var $rangeSlider = $('.js-filter-range');
var $resetRangeSld = $('.js-reset-range');
$rangeSlider.ionRangeSlider({
  type: 'double',
  hide_min_max: true
});
var $rangeDataReset = $rangeSlider.data('ionRangeSlider');
...
exports.Selectric = exports.Select = undefined;
...
var Selectric = exports.Selectric = new Select('.js-select');

/***/ }),
/* 7 */
/***/ (function(module, exports, __webpack_require__) {

var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;/*! Selectric ϟ v1.11.1 (2017-01-11) - git.io/tjl9sQ - Copyright (c) 2017 Leonardo Santos - MIT License */
  ...
  _createClass(Nav, [{
    ...
    value: function toggleNav() {
      this.$btn.on('click', function () {
        ...
        $(this).parent().next(this.$nav).toggleClass(_helpers.css.active);
...
var Filter = exports.Filter = function () {
  ...
  _createClass(Filter, [{
    ...
    value: function checkDevice() {
      ...
      _helpers.$window.on('load resize', function () {
        if (_helpers.Resp.isMobileAndTablet) {
          _this.openFilter();
        }
      });
    }
    ...
    value: function openFilter() {
      this.$openBtn.on('click', function () {
        $(this).next(this.$content).toggleClass(_helpers.css.visible);
      });
    }
  }, {
    key: 'init',
